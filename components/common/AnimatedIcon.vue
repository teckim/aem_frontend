<template>
  <div class="f-modal-alert">
    <div v-if="icon == 'error'" class="f-modal-icon f-modal-error animate">
    ...
    <div v-if="icon == 'warning'" class="f-modal-icon f-modal-warning scaleWarning">
      <span class="f-modal-body pulseWarningIns" />
      <span class="f-modal-dot pulseWarningIns" />
    </div>
    <div v-if="icon == 'success'" class="f-modal-icon f-modal-success animate">
